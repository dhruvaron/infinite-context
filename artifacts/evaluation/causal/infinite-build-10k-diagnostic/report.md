...
Generated: 2026-07-13T23:12:00.389Z<br>
Evidence class: production-path-no-cost-diagnostic<br>
Artifact result hash: `d6864864cdc6ce42ef884dc20fdd1527f9255b9f04e9fad6aa5a9fa156033026`
...
| flat\_hybrid | 43 | 65.8% | 53.0%–78.6% | 86.0% | 73.3% | 0.0% | 153555 | $0.0000 | 47.9 ms |
| continuum | 43 | 65.7% | 52.8%–78.5% | 91.9% | 73.3% | 0.0% | 173128 | $0.0000 | 52.7 ms |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| full | none | 43 | 65.7% | +0.0 pp | 91.9% | +0.0 pp | 73.3% | +0.0 pp | +0 |
| no_lexical | lexical | 43 | 54.0% | +11.7 pp | 65.1% | +26.7 pp | 56.7% | +16.7 pp | -9968 |
| no_vector | vector | 43 | 65.8% | -0.1 pp | 100.0% | -8.1 pp | 73.3% | +0.0 pp | +211 |
| no_reranking | reranking | 43 | 65.7% | +0.0 pp | 84.9% | +7.0 pp | 73.3% | +0.0 pp | +1 |
| no_temporal | temporal | 43 | 65.7% | -0.1 pp | 90.7% | +1.2 pp | 73.3% | +0.0 pp | +275 |
| no_topic_pages | topic_pages | 43 | 65.7% | -0.1 pp | 88.4% | +3.5 pp | 73.3% | +0.0 pp | -20204 |
| no_graph | graph | 43 | 65.7% | +0.0 pp | 90.7% | +1.2 pp | 73.3% | +0.0 pp | -1003 |
...
- PASS: graph-or-wiki-ablation-effect — Full retrieval must outperform no-graph or no-topic-pages on accuracy, Recall@10, or temporal accuracy; unchanged results remain an honest miss.
...
- PASS: retrieval-recall-at-10 — Continuum Retrieval Recall@10 must be at least 90%.
